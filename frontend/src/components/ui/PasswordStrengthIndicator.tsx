...
function PasswordStrengthIndicator({
  ...
  const containsPersonalInfo = () => {
    ...
    return values.some((v) => v.length >= 2 && lower.includes(v.toLowerCase()));
  };
  ...
  const rules = [
    ...
    {
      label: t("register.passwordRules.lowercase"),
      test: /[a-z]/.test(password),
    },
    ...
    {
      label: t("register.passwordRules.noPersonalInfo"),
      test: !containsPersonalInfo(),
    },
  ];
